...
CreateExcelModelFile(direct = direct, 
                     ...
                     area = 4, LastYearsModelRData = "SPA4_Model_2025", 
                     savefile = T)
...
raw.dat <- read.xlsx(paste0(direct,"/",assessmentyear, "/Assessment/Data/Model/SPA",area,"/SPA4_ModelData_R_2026-09-15.xlsx"),sheet = "AlignedForModel", cols=1:13)
...
Spa4.model <- SSModel(SPA4.dat,BoFSPA4.priors,SPA4.inits(NY),model.file=BoFmodel,Years=yrs, parms = parm, nchains=5,niter=600000,nburnin=250000,nthin=20) #,debug=T
...
#stats.output <- BoF.model.stats(area = "4", assessmentyear=2026, surveyyear=2026, direct = "Y:/Inshore/Assessment/BoF/", RDatafile = paste0("SPA4_Model_",surveyyear))
